...
const GoViewSystemKey = 'GO_SYSTEM';
// 用户
const GoViewUserInfo = 'userInfo';
// 请求
const GoViewTenantInfo = 'tenantInfo';
...
export function setGoView(userInfo, tenantInfo) {
  let data = localStorage.getItem(GoViewSystemKey);
  data = data ? JSON.parse(data) : {};
  data[GoViewUserInfo] = userInfo;
  data[GoViewTenantInfo] = tenantInfo;
  localStorage.setItem(GoViewSystemKey, JSON.stringify(data));
}
