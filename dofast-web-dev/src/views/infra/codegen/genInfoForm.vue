      ...
      <el-col :span="12">
        <el-form-item prop="templateType">
          ...
          <el-select v-model="info.templateType" @change="tplSelectChange">
            <el-option v-for="dict in this.getDictDatas(DICT_TYPE.INFRA_CODEGEN_TEMPLATE_TYPE)" :key="parseInt(dict.value)" :label="dict.label" :value="parseInt(dict.value)" />
          </el-select>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item prop="templateType">
          ...
          <el-select v-model="info.frontType">
            <el-option v-for="dict in this.getDictDatas(DICT_TYPE.INFRA_CODEGEN_FRONT_TYPE)" :key="parseInt(dict.value)" :label="dict.label" :value="parseInt(dict.value)" />
          </el-select>
        </el-form-item>
      </el-col>
      ...
      <el-col :span="12">
        <el-form-item prop="scene">
          ...
          <el-select v-model="info.scene">
            <el-option v-for="dict in this.getDictDatas(DICT_TYPE.INFRA_CODEGEN_SCENE)" :key="parseInt(dict.value)" :label="dict.label" :value="parseInt(dict.value)" />
          </el-select>
        </el-form-item>
      </el-col>
      <el-col :span="12">
