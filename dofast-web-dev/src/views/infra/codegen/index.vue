<template>
  <div class="app-container">
    <doc-alert title="代码生成" url="https://doc.huizhizao.vip/new-feature/" />
    <doc-alert title="单元测试" url="https://doc.huizhizao.vip/unit-test/" />
    <!-- 操作工作栏 -->
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button type="info" plain icon="el-icon-upload" size="mini" @click="openImportTable" v-hasPermi="['infra:codegen:create']">导入</el-button>
      </el-col>
...
<script>
import { getCodegenTablePage, previewCodegen, downloadCodegen, deleteCodegen, syncCodegenFromDB } from '@/api/infra/codegen';
...
export default {
  ...
  created() {
    this.queryParams = {
      ...
      tableComment: this.$route.query.tableComment,
      createTime: [],
    };
    this.getList();
    // 加载数据源
  ...
  methods: {
    ...
    handleEditTable(row) {
      ...
      const params = this.queryParams; // { pageNo: this.queryParams.pageNo };
