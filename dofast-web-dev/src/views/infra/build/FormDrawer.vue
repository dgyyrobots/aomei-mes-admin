      ...
      <div style="height: 100%">
        <el-row style="height: 100%; overflow: auto">
          <el-col :md="24" :lg="12" class="left-editor">
            ...
            <div v-model="codemirrorOptions.value" :theme="codemirrorOptions.theme" class="tab-editor" :options="codemirrorOptions" @keydown="onKeyDown" />
          </el-col>
          <el-col :md="24" :lg="12" class="right-preview">
            ...
            <iframe v-show="isIframeLoaded" ref="previewPage" class="result-wrapper" frameborder="0" src="preview.html" @load="iframeLoad" />
...
export default {
  ...
  computed: {
    ...
    codemirrorOptions() {
      return {
        value: this[this.activeTab + 'Code'],
        mode: mode[this.activeTab],
