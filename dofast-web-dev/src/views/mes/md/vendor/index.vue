  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="100px">
      ...
      <el-form-item label="供应商简称" prop="vendorNick">
        <el-input v-model="queryParams.vendorNick" placeholder="请输入供应商简称" clearable @keyup.enter.native="handleQuery" />
      </el-form-item>

      <el-form-item label="英文名称" prop="vendorEn">
        <el-input v-model="queryParams.vendorEn" placeholder="请输入供应商英文名称" clearable @keyup.enter.native="handleQuery" />
      </el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button type="primary" plain icon="el-icon-plus" size="mini" @click="handleAdd"
          v-hasPermi="['mes:md-vendor:create']">新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="success" plain icon="el-icon-edit" size="mini" :disabled="single" @click="handleUpdate"
          v-hasPermi="['mes:md-vendor:update']">修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="danger" plain icon="el-icon-delete" size="mini" :disabled="multiple" @click="handleDelete"
          v-hasPermi="['mes:md-vendor:delete']">删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="warning" plain icon="el-icon-download" size="mini" @click="handleExport"
          v-hasPermi="['mes:md-vendor:export']">导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="vendorList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="供应商编码" align="center" prop="vendorCode">
        <template slot-scope="scope">
          <el-button type="text" @click="handleView(scope.row)" v-hasPermi="['mes:md-vendor:query']">{{
          ...
          <el-col :span="12">
            <el-form-item label="供应商等级" prop="vendorLevel">
              <el-select v-model="form.vendorLevel" placeholder="请选择供应商等级">
                <el-option v-for="dict in dict.type.mes_vendor_level" :key="dict.value" :label="dict.label"
  ...
  methods: {
    ...
    getList() {
      ...
      listVendor(this.queryParams).then(response => {
        this.vendorList = response.data.list;
    ...
    /** 删除按钮操作 */
    handleDelete(row) {
      const vendorIds = row.id || this.ids;
      this.$modal
        .confirm('是否确认删除供应商编号为"' + vendorIds + '"的数据项？')
        .then(function () {
