  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="100px">
      ...
      <el-form-item label="工作站编码" prop="workstationCode">
        <el-input v-model="queryParams.workstationCode" placeholder="请输入工作站编码" clearable
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button type="primary" plain icon="el-icon-plus" size="mini" @click="handleAdd"
          v-hasPermi="['mes:md-workstation:create']">新增 </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="success" plain icon="el-icon-edit" size="mini" :disabled="single" @click="handleUpdate"
          v-hasPermi="['mes:md-workstation:update']">修改 </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="danger" plain icon="el-icon-delete" size="mini" :disabled="multiple" @click="handleDelete"
          v-hasPermi="['mes:md-workstation:delete']">删除 </el-button>
      </el-col>
      <el-col :span="1.5">
    ...
    <el-table v-loading="loading" :data="workstationList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="工作站编号" align="center" prop="workstationCode">
        <template slot-scope="scope">
          <el-button type="text" @click="handleView(scope.row)" v-hasPermi="['mes:md-workstation:query']">
    ...
    <el-dialog :title="title" :visible.sync="open" width="960px" append-to-body>
      ...
      <el-divider content-position="center" v-if="form.id != null">工作站资源</el-divider>
          ...
          <el-carousel trigger="click" type="card" :autoplay="false">
            <el-carousel-item>
              <el-card shadow="always" style="width: 450px">
                <div slot="header">
                  <span>设备资源</span>
                  <el-button style="float: right; padding: 3px 0" @click="handleMachineryAdd" v-if="optType != 'view'"
                    type="text">新增 </el-button>
                </div>
                <WorkStationMachine ref="machineryList" :optType="optType" :workstationId="form.id" style="align: center">
                </WorkStationMachine>
              </el-card>
            </el-carousel-item>
            <el-carousel-item>
              <el-card shadow="always" style="width: 400px">
                <div slot="header">
                  <span>人力资源</span>
                  <el-button style="float: right; padding: 3px 0" @click="handlePostAdd" v-if="optType != 'view'"
                    type="text">新增 </el-button>
                </div>
                <Workstationworker ref="postList" :optType="optType" :workstationId="form.id"></Workstationworker>
              </el-card>
            </el-carousel-item>
            <el-carousel-item>
              <el-card shadow="always" style="width: 400px">
                <div slot="header">
                  <span>工装夹具</span>
                  <el-button style="float: right; padding: 5px 0" @click="handleToolTypeAdd" v-if="optType != 'view'"
                    type="text">新增 </el-button>
                </div>
                <WorkStationTool ref="toolList" :optType="optType" :workstationId="form.id"></WorkStationTool>
              </el-card>
            </el-carousel-item>
          </el-carousel>
        </el-col>
  ...
  methods: {
    ...
    getList() {
      ...
      listWorkstation(this.queryParams).then(response => {
        this.workstationList = response.data.list;
    ...
    /** 删除按钮操作 */
    handleDelete(row) {
      const workstationIds = row.id || this.ids;
      this.$modal
        .confirm('是否确认删除工作站？')
        .then(function () {
    ...
    onMachineryAdd(rows) {
      this.loading = true;
      rows.workstationId = this.form.id;
      rows.machineryId = rows.id;
