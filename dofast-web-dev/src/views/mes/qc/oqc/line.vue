  ...
  <div class="app-container">
    <el-table v-loading="loading" :data="oqclineList">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button size="mini" type="text" icon="el-icon-edit" @click="handleDefect(scope.row)" v-hasPermi="['qms:oqc-line:update']" v-if="optType != 'view'">缺陷记录</el-button>
        </template>
      </el-table-column>
    </el-table>
  ...
  methods: {
    ...
    getList() {
      ...
      listOqcline(this.queryParams).then(response => {
        this.oqclineList = response.data.list;
