  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="消耗日期" prop="consumeDate">
        <el-date-picker clearable v-model="queryParams.consumeDate" type="date" value-format="timestamp" placeholder="请选择消耗日期"> </el-date-picker>
      </el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button type="primary" plain icon="el-icon-plus" size="mini" @click="handleAdd" v-hasPermi="['wm:itemconsume:add']">新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="success" plain icon="el-icon-edit" size="mini" :disabled="single" @click="handleUpdate" v-hasPermi="['wm:itemconsume:edit']">修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="danger" plain icon="el-icon-delete" size="mini" :disabled="multiple" @click="handleDelete" v-hasPermi="['wm:itemconsume:remove']">删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="warning" plain icon="el-icon-download" size="mini" @click="handleExport" v-hasPermi="['wm:itemconsume:export']">导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="itemconsumeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button size="mini" type="text" icon="el-icon-edit" @click="handleUpdate(scope.row)" v-hasPermi="['wm:itemconsume:edit']">修改</el-button>
          <el-button size="mini" type="text" icon="el-icon-delete" @click="handleDelete(scope.row)" v-hasPermi="['wm:itemconsume:remove']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="消耗日期" prop="consumeDate">
          <el-date-picker clearable v-model="form.consumeDate" type="date" value-format="timestamp" placeholder="请选择消耗日期"> </el-date-picker>
        </el-form-item>
  ...
  methods: {
    ...
    getList() {
      ...
      listItemconsume(this.queryParams).then(response => {
        this.itemconsumeList = response.data.list;
    ...
    handleDelete(row) {
      ...
      this.$modal
        .confirm('是否确认删除物料消耗记录编号为"' + recordIds + '"的数据项？')
        .then(function () {
