<template>
  ...
  >
    <div class="dialog-content">
      <MesRegistrationView ref="view" :task-code="taskCode" modal-class="cyber-modal" main-class="time-registration-dialog"/>
    </div>
...
<script>
import MesRegistrationView from '@/views/mes/registration/index.vue'
// 控制对话框显示状态
export default {
  name: 'MesRegistrationDialog',
  props: {
    taskCode: {
      type: String,
      default: '',
