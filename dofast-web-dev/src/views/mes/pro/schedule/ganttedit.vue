<template>
  <div class="app-container">
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button type="success" plain icon="el-icon-edit" size="mini" @click="handleUpdate" v-hasPermi="['pro:task:update']">保存 </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="danger" plain icon="el-icon-delete" size="mini" @click="handleClose">关闭</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="warning" plain icon="el-icon-refresh" size="mini" @click="handleRefresh">重新加载</el-button>
      </el-col>
    </el-row>
    <div class="wrapper">
      <div class="container">
    ...
    handleUpdate() {
      if (this.changedTaskIds.length > 0) {
        ...
        this.changedTaskIds.forEach(id => {
          ...
          this.form.endTime = endDate.getTime();
          updateProtask(this.form).then(
            response => {
