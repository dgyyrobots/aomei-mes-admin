<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button type="primary" plain icon="el-icon-plus" size="mini" @click="handleAdd" v-hasPermi="['pro:route:create']">新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="success" plain icon="el-icon-edit" size="mini" :disabled="single" @click="handleUpdate" v-hasPermi="['pro:route:update']">修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="danger" plain icon="el-icon-delete" size="mini" :disabled="multiple" @click="handleDelete" v-hasPermi="['pro:route:delete']">删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="warning" plain icon="el-icon-download" size="mini" @click="handleExport" v-hasPermi="['pro:route:export']">导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="prorouteList" @selection-change="handleSelectionChange" ref="multipleTable" @row-click="handleRowClick">
      ...
      <el-table-column label="工艺路线编号" align="center" prop="routeCode">
        <template slot-scope="scope">
          <el-button type="text" @click="handleView(scope.row)" v-hasPermi="['pro:route:query']">{{ scope.row.routeCode }}</el-button>
        </template>
      </el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="open" width="960px" append-to-body>
      ...
      <el-tabs type="border-card" v-if="form.id != null">
        <el-tab-pane label="组成工序">
          <Routeprocess v-if="form.id != null" :optType="optType" :routeId="form.id"></Routeprocess>
        </el-tab-pane>
        <el-tab-pane label="关联产品">
          <Routeproduct v-if="form.id != null" :optType="optType" :routeId="form.id"></Routeproduct>
        </el-tab-pane>
      </el-tabs>
  ...
  methods: {
    ...
    getList() {
      ...
      listProroute(this.queryParams).then(response => {
        this.prorouteList = response.data.list;
