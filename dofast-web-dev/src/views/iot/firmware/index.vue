        ...
        <el-card v-show="showSearch" style="margin-bottom:6px;">
            <el-form :model="queryParams" ref="queryForm" :inline="true" label-width="68px" style="margin-bottom:-20px;">
                <el-form-item label="固件名称" prop="firmwareName">
                    <el-input v-model="queryParams.firmwareName" placeholder="请输入固件名称" clearable size="small"
                ...
                <el-form-item style="float:right;">
                    <el-button type="primary" plain icon="el-icon-plus" size="mini" @click="handleAdd"
                        v-hasPermi="['iot:firmware:create']">新增</el-button>
                </el-form-item>
            </el-form>
        </el-card>
                ...
                <el-table-column label="操作" align="center" class-name="small-padding fixed-width" width="200">
                    <template slot-scope="scope">
                        <el-button size="small" type="primary" style="padding:5px;" icon="el-icon-edit"
                            @click="handleUpdate(scope.row)" v-hasPermi="['iot:firmware:update']">修改</el-button>
                        <el-button size="small" type="danger" style="padding:5px;" icon="el-icon-delete"
                            @click="handleDelete(scope.row)" v-hasPermi="['iot:firmware:delete']">删除</el-button>
                    </template>
                </el-table-column>
            </el-table>
    ...
    methods: {
        ...
        getProductShortList() {
            listShortProduct().then(response => {
                this.productShortList = response.data.list;
            });
        },
        // 取消按钮
        cancel() {
