            ...
            <el-form :model="queryParams" ref="queryForm" :inline="true" label-width="68px" style="margin-bottom:-20px;">
                ...
                <el-form-item style="float:right;">
                    <el-button type="primary" plain icon="el-icon-plus" size="mini" @click="handleAdd"
                        v-hasPermi="['iot:group:create']">新增</el-button>
                </el-form-item>
            </el-form>
        </el-card>
        ...
        <el-card style="padding-bottom:100px;">
            <el-table v-loading="loading" :data="groupList" @selection-change="handleSelectionChange" border>
                ...
                <el-table-column label="操作" align="center" class-name="small-padding fixed-width" width="320">
                    <template slot-scope="scope">
                        <el-button size="small" type="warning" style="padding:5px;" icon="el-icon-search"
                            @click="handleViewDevice(scope.row.groupId)" v-hasPermi="['iot:device:query']">查看设备</el-button>
                        <el-button size="small" type="success" style="padding:5px;" icon="el-icon-edit"
                            @click="selectDevice(scope.row)" v-hasPermi="['iot:group:update']">添加设备</el-button>
                        <el-button size="small" type="primary" style="padding:5px;" icon="el-icon-edit"
                            @click="handleUpdate(scope.row)" v-hasPermi="['iot:group:update']">修改</el-button>
                        <el-button size="small" type="danger" style="padding:5px;" icon="el-icon-delete"
                            @click="handleDelete(scope.row)" v-hasPermi="['iot:group:delete']">删除</el-button>
                    </template>
                </el-table-column>
            </el-table>
