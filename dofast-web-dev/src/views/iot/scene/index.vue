        ...
        <el-card v-show="showSearch" style="margin-bottom:6px;">
            ...
            <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px"
                ...
                <el-form-item label="场景名称" prop="sceneName">
                    <el-input v-model="queryParams.sceneName" placeholder="请输入场景名称" clearable size="small"
            ...
            <el-row :gutter="10" class="mb8">
                <el-col :span="1.5">
                    <el-button type="primary" plain icon="el-icon-plus" size="mini" @click="handleAdd"
                        v-hasPermi="['iot:scene:create']">新增</el-button>
                </el-col>
                <el-col :span="1.5">
                    <el-button type="success" plain icon="el-icon-edit" size="mini" :disabled="single" @click="handleUpdate"
                        v-hasPermi="['iot:scene:update']">修改</el-button>
                </el-col>
                <el-col :span="1.5">
                    <el-button type="danger" plain icon="el-icon-delete" size="mini" disabled @click="handleDelete"
                        v-hasPermi="['iot:scene:delete']">删除</el-button>
                </el-col>
                <el-col :span="1.5">
                    <el-button type="warning" plain icon="el-icon-download" size="mini" @click="handleExport"
                        v-hasPermi="['iot:scene:export']">导出</el-button>
                </el-col>
                ...
                <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
                    <template slot-scope="scope">
                        <el-button size="mini" type="text" icon="el-icon-edit" @click="handleUpdate(scope.row)"
                            v-hasPermi="['iot:scene:edit']">修改</el-button>
                        <el-button size="mini" type="text" icon="el-icon-delete" @click="handleDelete(scope.row)"
                            v-hasPermi="['iot:scene:remove']" disabled>删除</el-button>
                    </template>
                </el-table-column>
            </el-table>
                    ...
                    <el-row>
                        ...
                        <el-col :span="24">
                            <el-form-item label="触发器" prop="griggers">
                                <el-select v-model="form.condition" placeholder="请选择" size="small"
                                    style="margin-bottom:10px;">
                                    <el-option v-for="item in triggerConditions" :key="item.value" :label="item.label"
                                        :value="item.value">
                                    </el-option>
                                </el-select>
                                <div v-for="(item, index) in form.triggers" :key="index"
                                    ...
                                    <el-row>
                                        ...
                                        <el-col :span="16" :offset="1" v-if="item.source == 1">
                                            <el-link :underline="false">请选择一个设备<i
                                                    class="el-icon-edit el-icon--right"></i></el-link>
                                        </el-col>
                                        <el-col :span="16" :offset="1" v-if="item.source == 2">
                                            <el-time-picker v-model="timerTimeValue" size="small" value-format="HH:mm"
                                    ...
                                    <el-row v-if="item.source == 1">
                                        <el-col :span="4">
                                            <el-select v-model="item.modelType" placeholder="请选择" size="small">
                                                <el-option v-for="subItem in modelTypes" :key="subItem.value"
                                                    :label="subItem.label" :value="subItem.value">
                                                </el-option>
                                            </el-select>
                                        </el-col>
                                    ...
                                    <el-row v-if="item.source == 2">
                                        <el-col :span="24">
                                            <el-row style="margin-bottom:5px;">
                                                <el-col :span="4">
                                                    <el-select v-model="timerWeekRepeatValue" placeholder="请选择"
                                                        @change="repeatChange" size="small" :disabled="item.isAdvance == 1">
                                                        <el-option v-for="item in timerWeekRepeats" :key="item.value"
                                                            :label="item.label" :value="item.value">
                                                        </el-option>
                                                    </el-select>
                                                </el-col>
                                                <el-col :span="15" :offset="1" v-if="timerWeekRepeatValue == 3">
                                                    <el-select v-model="timerWeekValue" placeholder="请选择" multiple
                                                        style="width:485px" @change="weekChange" size="small"
                                                        :disabled="item.isAdvance == 1">
                                                        <el-option v-for="item in timerWeeks" :key="item.value"
                                                            :label="item.label" :value="item.value">
                                                        </el-option>
                                                    </el-select>
                                                </el-col>
                                        ...
                                        <el-col :span="24">
                                            <el-row>
                                                ...
                                                <el-col :span="4" :offset="1">
                                                    <el-checkbox v-model="item.isAdvance" :true-label="1" :false-label="0"
                                    ...
                                    <el-row v-if="item.source == 3">
                                        <el-col :span="4">
                                            <el-select v-model="item.alertLevel" placeholder="告警级别" size="small">
                                                <el-option v-for="dict in dict.type.iot_alert_level" :key="dict.value"
