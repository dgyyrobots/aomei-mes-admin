<template>
    <div style="padding-left:20px;">
        <el-row :gutter="10" class="mb8">
            <el-col :span="1.5">
                <!-- v-hasPermi="['iot:device:share']" -->
                <el-button type="primary" plain icon="el-icon-share" size="mini" @click="selectUser">分享设备</el-button>
            </el-col>
            <el-col :span="1.5">
            ...
            <el-table-column label="操作" align="center" class-name="small-padding fixed-width" width="150">
                <template slot-scope="scope">
                    ...
                    <el-button size="mini" type="text" icon="el-icon-edit" @click="handleUpdate(scope.row)"
                        v-if="scope.row.isOwner == 0">备注</el-button>
                    <!-- v-hasPermi="['iot:device:share']" -->
                    <el-button size="mini" type="text" icon="el-icon-delete" @click="handleDelete(scope.row)"
                        v-if="scope.row.isOwner == 0">取消分享</el-button>
                </template>
            </el-table-column>
        </el-table>
    ...
    methods: {
        ...
        getList() {
            ...
            listDeviceUser(this.queryParams).then(response => {
                this.deviceUserList = response.data.list;
