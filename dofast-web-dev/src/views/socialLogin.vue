<template>
  <div class="container">
    ...
    <div class="content">
      ...
      <div class="field">
        ...
        <h2 class="mobile-title">
          <h3 class="title">澳美MES系统</h3>
        </h2>

        <!-- 表单 -->
        <div class="form-cont">
          <el-tabs class="form" v-model="loginForm.loginType" style="float: none">
            <el-tab-pane label="绑定账号" name="uname"> </el-tab-pane>
          </el-tabs>
          <div>
    ...
    <!-- footer -->
    <div class="footer">Copyright © 2020-2022 huizhizao.vip All Rights Reserved.</div>
  </div>
</template>

<script>
import { getPassword, getRememberMe, getUsername, removePassword, removeUsername, setPassword, setRememberMe, setUsername } from '@/utils/auth';
