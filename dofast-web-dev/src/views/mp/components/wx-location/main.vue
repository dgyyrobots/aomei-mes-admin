...
<template>
  <div>
    <el-link type="primary" target="_blank" :href="'https://map.qq.com/?type=marker&isopeninfowin=1&markertype=1&pointx=' + locationY + '&pointy=' + locationX + '&name=' + label + '&ref=dofast'">
      ...
      <p />
      <i class="el-icon-map-location"></i>{{ label }}
    </el-link>
  </div>
</template>
