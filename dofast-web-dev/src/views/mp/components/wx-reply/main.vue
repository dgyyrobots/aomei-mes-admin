      ...
      <el-row>
        ...
        <div v-else>
          <el-row style="text-align: center">
            ...
            <!-- 文件上传 -->
            <el-col :span="12" class="col-add">
              <el-upload :action="actionUrl" :headers="headers" multiple :limit="1" :file-list="fileList" :data="uploadData" :before-upload="beforeVoiceUpload" :on-success="handleUploadSuccess">
    ...
    <el-tab-pane name="video">
      ...
      <el-row>
        ...
        <el-row style="text-align: center">
          ...
          <!-- 文件上传 -->
          <el-col :span="12">
            <el-upload :action="actionUrl" :headers="headers" multiple :limit="1" :file-list="fileList" :data="uploadData" :before-upload="beforeVideoUpload" :on-success="handleUploadSuccess">
...
export default {
  ...
  methods: {
    ...
    beforeVoiceUpload(file) {
      // 校验格式
      const isType = file.type === 'audio/mp3' || file.type === 'audio/mpeg' || file.type === 'audio/wma' || file.type === 'audio/wav' || file.type === 'audio/amr';
      if (!isType) {
