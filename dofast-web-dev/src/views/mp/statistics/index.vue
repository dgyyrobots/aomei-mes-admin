<template>
  <div class="app-container">
    <doc-alert title="公众号统计" url="https://doc.huizhizao.vip/mp/statistics/" />
    ...
    <el-form ref="queryForm" size="small" :inline="true" label-width="68px">
      ...
      <el-form-item label="时间范围" prop="date">
        <el-date-picker v-model="date" style="width: 260px" value-format="yyyy-MM-dd HH:mm:ss" type="daterange" range-separator="-" start-placeholder="开始日期" end-placeholder="结束日期" :picker-options="datePickerOptions" :default-time="['00:00:00', '23:59:59']" @change="getSummary">
        </el-date-picker>
      </el-form-item>
    </el-form>
