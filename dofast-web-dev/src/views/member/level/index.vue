  ...
  <div class="app-container">
    ...
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <!-- <el-form-item label="升级经验" prop="experience">
        <el-input v-model="queryParams.experience" placeholder="请输入升级经验" clearable @keyup.enter.native="handleQuery" />
      </el-form-item> -->
      <!-- <el-form-item label="享受折扣" prop="discountPercent">
        <el-input v-model="queryParams.discountPercent" placeholder="请输入享受折扣" clearable
          @keyup.enter.native="handleQuery" />
      </el-form-item> -->
      <!-- <el-form-item label="等级图标" prop="icon">
        <el-input v-model="queryParams.icon" placeholder="请输入等级图标" clearable @keyup.enter.native="handleQuery" />
      </el-form-item> -->
      <!-- <el-form-item label="等级背景图" prop="backgroundUrl">
        <el-input v-model="queryParams.backgroundUrl" placeholder="请输入等级背景图" clearable
          @keyup.enter.native="handleQuery" />
      </el-form-item> -->
    ...
    <el-table v-loading="loading" :data="list">
      ...
      <el-table-column label="升级经验" align="center" prop="experience" />
      <el-table-column label="享受折扣" align="center" prop="discountPercent" />
      <el-table-column label="等级图标" align="center" prop="icon" />
      <el-table-column label="等级背景图" align="center" prop="backgroundUrl" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" v-dialogDrag append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="等级背景图" prop="backgroundUrl">
          <el-input v-model="form.backgroundUrl" placeholder="请输入等级背景图" />
        </el-form-item>
        <el-form-item label="状态" prop="status">
...
<script>
import { createLevel, updateLevel, deleteLevel, getLevel, getLevelPage, exportLevelExcel } from "@/api/member/level";
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        icon: [{ required: true, message: "等级图标不能为空", trigger: "blur" }],
        backgroundUrl: [{ required: true, message: "等级背景图不能为空", trigger: "blur" }],
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      // 执行查询
      getLevelPage(this.queryParams).then(response => {
