<template>
  <el-dialog title="选择仓库" v-if="showFlag" :visible.sync="showFlag" :modal="false" width="800px" center>
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="仓库名称" prop="name">
        <el-input v-model="queryParams.name" placeholder="请输入仓库名称" clearable @keyup.enter.native="handleQuery" />
      </el-form-item>

      <el-form-item label="仓库地址" prop="locaiton">
        <el-input v-model="queryParams.locaiton" placeholder="请输入仓库地址" clearable @keyup.enter.native="handleQuery" />
      </el-form-item>
