<template>
  <el-dialog title="库存物资选择" v-if="showFlag" :visible.sync="showFlag" :modal="false" width="80%" center>
    <el-row :gutter="20">
      <el-col :span="4" :xs="24">
          ...
          <el-row>
            <el-col :span="8">
              <el-form-item label="物资编码" prop="itemCode">
                <el-input v-model="queryParams.itemCode" :disabled="itemFag" placeholder="请输入产品物料编码" clearable @keyup.enter.native="handleQuery" />
              </el-form-item>
            </el-col>
            <el-col :span="8">
