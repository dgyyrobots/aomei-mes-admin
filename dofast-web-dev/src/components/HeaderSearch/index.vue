<template>
  <div :class="{ show: show, [searchPosition]: true, [mode]: true }" class="header-search">
    <svg-icon class-name="search-icon" icon-class="search" @click.stop="click" v-if="searchPosition != 'right'" />
