<template>
  <div class="editPage__video">
    <el-upload class="uploader" list-type="picture-card" :action="uploadUrl" :on-success="handleSuccess" :before-upload="beforeUpload" :headers="headers" :on-error="handleError" :show-file-list="false">
      <div v-if="uploadFlag" @mouseenter="mouseover" @mouseleave="mouseout">
        <i class="el-icon-success success-icon"></i>
        <div :class="{ hide: activeHover, success: !activeHover }">
          <span class="item-actions">
            <span class="item-preview" @click.stop="handlePreview()">
