<template>
  <el-dialog title="班组选择" v-if="showFlag" :visible.sync="showFlag" :modal="false" width="80%" center>
    ...
    <el-table v-loading="loading" :data="teamList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="班组编号" align="center" prop="teamCode"> </el-table-column>
