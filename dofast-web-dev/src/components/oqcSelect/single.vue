<template>
  <el-dialog title="客户选择" v-if="showFlag" :visible.sync="showFlag" :modal="false" width="80%" center>
    ...
    <el-table v-loading="loading" :data="oqcList" @current-change="handleCurrent" @row-dblclick="handleRowDbClick">
      ...
      <el-table-column label="出货检验单编号" width="150px" align="center" prop="oqcCode"> </el-table-column>
