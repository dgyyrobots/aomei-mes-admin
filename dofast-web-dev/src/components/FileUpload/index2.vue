  ...
  <div class="upload-file">
    ...
    <transition-group class="upload-file-list el-upload-list el-upload-list--text" name="el-fade-in-linear" tag="ul">
      <li :key="file.url" class="el-upload-list__item ele-upload-list__item-content flex"
        ...
        <el-image v-if="isImage(file.url)" :src="file.url" fit="cover" style="width: 144px; height: 81px"
          :preview-src-list="fileList.filter(({ url }) => isImage(url)).map(({ url }) => url)"></el-image>
